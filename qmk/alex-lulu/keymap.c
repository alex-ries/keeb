 ...
 */
 ...
 [_BASE] = LAYOUT(
  ...
  KC_BSPC,  M_AW,     M_RA,     M_SC,     M_TC,         KC_G,                     KC_M,       M_NC,       M_EC,       M_IA,       M_OW,       _______,
  KC_DEL,   KC_Z,     M_XA,     KC_C,     KC_D,         KC_V, KC_LBRC,  KC_RBRC,  KC_K,       KC_H,       KC_COMM,    M_DOTA,     KC_SLSH,    _______,
                      _______,  KC_ESC,   KC_TAB,       KC_SPC,                   KC_ENT,     KC_DEL,     KC_BSPC,    _______
),
/* GAME
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      |      |SPACE | /  ALT  /       \Enter \  |RAISE |BackSP| RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
